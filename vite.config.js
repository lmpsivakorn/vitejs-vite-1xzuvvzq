...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@dataconnect/generated": fileURLToPath(new URL("./src/dataconnect-generated", import.meta.url)),
    },
  },
  build: {
  ...
  server: {
    ...
    proxy: {
      "/api/token": {
        target: "http://127.0.0.1:5001/tkt-project-602fe/us-central1/auth-callback",
        changeOrigin: true,
      },
    },
  },
